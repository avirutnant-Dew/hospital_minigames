...
import { QuestionChallenge } from "@/components/game/QuestionChallenge";
import { Button } from "@/components/ui/button";
import { ArrowLeft, AlertCircle } from "lucide-react";
import { supabase } from "@/integrations/supabase/client";
import { useEffect } from "react";

export default function QuestionChallengePage() {
  ...
  const handleGameEnd = async (score: number) => {
    // Clear the pending challenge and navigate back
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-background via-background to-accent/5 p-4 flex items-center justify-center">
        <div className="max-w-2xl mx-auto">
          <div className="glass-card p-8 text-center space-y-6">
            ...
            <h2 className="text-2xl font-display font-bold">Challenge Not Available</h2>
            <p className="text-muted-foreground">
              This challenge needs to be started from the main game board by a team.
            </p>
