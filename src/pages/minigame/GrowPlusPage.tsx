...
import { GrowPlusGameType } from "@/components/game/growplus/types";
...
export default function GrowPlusPage() {
  ...
  const gameType = gameTypeParam as GrowPlusGameType | undefined;

  // Debug log
  useEffect(() => {
    console.log('GrowPlusPage - teamId:', teamId, 'gameTypeParam:', gameTypeParam, 'gameType:', gameType);
  }, [teamId, gameTypeParam, gameType]);
